...
// 当参数有 2 个时，第一个参数为 key，第二个参数为其要增加的值 int64 类型。
func (rds RedisClient) Increment(paramters ...interface{}) bool {
...
// Decrement 当参数只有 1 个时，为 key，其值减少 1。
// 当参数有 2 个时，第一个参数为 key，第二个参数为其要减少的值 int64 类型。
